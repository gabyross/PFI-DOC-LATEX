...
\newpagestyle{ruled}{
  \sethead{\includegraphics[width=3.4cm]{./images/UADE_LARGE}}
      {\parbox[b]{0.58\textwidth}{\raggedright\MakeUppercase{Smartstocker: Predicción de ventas y optimización de inventario}}}
      {
        \raisebox{1.3ex}{%
          \parbox[b]{0.22\textwidth}{\raggedleft
          \begin{tabular}{r}
            Cano, Nicolás \\
            Venegas, Gabriela
          \end{tabular}
