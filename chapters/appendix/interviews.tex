...
\begin{description}[leftmargin=0cm, labelsep=0.5cm]
  ...
  \item[\textbf{Entrevistador:}] ¿Podrías describir tu negocio, qué venden, cuántos locales tienen y cuántos empleados están actualmente contratados?

  \item[\textbf{Ulises Litterio:}] El negocio es comercializar hamburguesas, con producción desde la compra de la materia prima, elaboración y venta con \textit{deliveries} propios. Actualmente tenemos 3 locales, con un total de 25 empleados entre todos. Se cuenta con varios proveedores para cada materia prima. Nuestros locales funcionan 6 días a la semana, en turnos de día y noche.

  \item[\textbf{Entrevistador:}] Puntualizando en el inventario: ¿cómo lo controlan? ¿Usan software o planillas? ¿Cuándo realizan compras a proveedores?
...
\begin{description}[leftmargin=0cm, labelsep=0.5cm]
  ...
  \item[\textbf{Entrevistador:}] Sobre el inventario: ¿cómo lo controlan? ¿Usan software o planillas? ¿Cada cuánto compran?
