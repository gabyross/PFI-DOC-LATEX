...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/resultados.png}
    \caption{Resultados del modelo.}
    {\textit{Fuente: Elaboración propia.}}
    \label{fig:resultados-modelo}
\end{figure}

Podemos ver que tanto el RMSE como el MAE presentan valores bajos, lo que indica que el modelo es apto para la tarea de predicción de ventas enfocada a la gestión de inventario.
