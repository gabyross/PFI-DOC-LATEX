...
\begin{table}[H]
\centering
{\textbf{Tabla \ref{tab:planes-suscripcion}. Planes de suscripción de SmartStocker.}}\\[-0.3em]
{\textit{Fuente: Elaboración propia.}}\\[0.8em]
...
Inicial & Integración con una única plataforma de delivery. Hasta 2000 ventas al mes. & 90 \\ \hline
Intermedio & Integración con hasta dos plataformas de delivery. Soporte por mensajería. Hasta 5000 ventas al mes. & 120 \\ \hline
Avanzado & Integración con todas las plataformas disponibles. Posibilidad de integraciones personalizadas. Soporte telefónico exclusivo. Hasta 8000 ventas al mes. & 140 \\ \hline
\end{tabular}
...
\begin{table}[H]
\centering
{\textbf{Tabla \ref{tab:excedentes}. Cargos por excedente de ventas.}}\\[-0.3em]
{\textit{Fuente: Elaboración propia.}}\\[0.8em]
...
Inicial & Superior a 2000 & 0.25 \\ \hline
Intermedio & Superior a 5000 & 0.20 \\ \hline
Avanzado & Superior a 8000 & 0.10 \\ \hline
\end{tabular}
...
\begin{table}[H]
\centering
{\textbf{Tabla \ref{tab:recursos-insumos}. Recursos e insumos del proyecto (estimación por año).}}\\[-0.3em]
{\textit{Fuente: Elaboración propia.}}\\[0.4em]
...
\begin{table}[H]
\centering
{\textbf{Tabla \ref{tab:infra-aws}. Costo de infraestructura AWS (anual).}}\\[-0.3em]
{\textit{Fuente: Elaboración propia.}}\\[0.5em]
...
\begin{table}[H]
\centering
{\textbf{Tabla \ref{tab:van-escenarios}. Valor actual neto por escenario.}}\\[-0.3em]
{\textit{Fuente: Elaboración propia.}}\\[0.8em]
...
\begin{table}[H]
\centering
{\textbf{Tabla \ref{tab:tir-escenarios}. Tasa interna de retorno por escenario.}}\\[-0.3em]
{\textit{Fuente: Elaboración propia.}}\\[0.8em]
...
\begin{table}[H]
\centering
{\textbf{Tabla \ref{tab:payback-escenarios}. Período de recuperación por escenario.}}\\[-0.3em]
{\textit{Fuente: Elaboración propia.}}\\[0.8em]
...
\begin{table}[H]
\centering
{\textbf{Tabla \ref{tab:flujo-fondos}. Flujo de fondos proyectado por escenario.}}\\[-0.3em]
{\textit{Fuente: Elaboración propia.}}\\[0.8em]
